...
"""
def runRutina05(directorio,night):
    ...
    for fichero in listdir(directorio+"/"+night):
        if os.path.isfile(directorio+"/"+night+"/"+fichero) and fichero.endswith(".fits"):
            rutaFich=directorio+"/"+night+"/"+fichero
            # Abrimos el fichero
    ...
    outfile = open(TMP_RESULTS+"/Rut05_dat/eficiencia_"+night+".txt","w")
